...
namespace ApPotter\OAuth2Server\Middleware;

use Closure;
use League\OAuth2\Server\Exception\InvalidScopeException;
use ApPotter\OAuth2Server\Authorizer;
...
class OAuthMiddleware
{
     ...
     *
     * @var \ApPotter\OAuth2Server\Authorizer
     */
     ...
     *
     * @param \ApPotter\OAuth2Server\Authorizer $authorizer
