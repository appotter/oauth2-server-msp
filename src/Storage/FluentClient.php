...
namespace ApPotter\OAuth2Server\Storage;
...
class FluentClient extends AbstractFluentAdapter implements ClientInterface
{
		...
		if ( ! is_null($redirectUri) && is_null($clientSecret))
		{
			$query = $this->getConnection()->table('oauth_clients')
					->select(
						...
						'oauth_clients.branch_id as branch_id',
						'oauth_clients.group as group'
					)
	 ...
	 * @return string
	 */
	public function create($name, $id, $secret, $branch_id, $group = 'staff')
	{
